package br.edu.ifsp.arq.ads.dw2s6.achadosedescontos.config;
...
import br.edu.ifsp.arq.ads.dw2s6.achadosedescontos.security.SystemUser;
...
public class AuthorizationServerConfig {
    ...
    JWKSet jwkSet() throws Exception {
        final InputStream inputStream = new ClassPathResource("keystore/achadosedescontos.jks")
        		.getInputStream();
        
        final KeyStore keyStore = KeyStore.getInstance("JKS");
        keyStore.load(inputStream, "123456".toCharArray());
    	
    	RSAKey rsa = RSAKey.load(keyStore, "achadosedescontos", "123456".toCharArray());
